    ...
    if (typeof window !== 'undefined' && !alreadyTracked) {
      ...
      script.onload = async () => {
        ...
        window.gtag('event', 'conversion', {
          'send_to': 'AW-17218323030/aj9dCP3Lhu8bENaEq5JA',
          'value': ecValue,
          'currency': 'EUR',
      ...
      <div className="ty-box" style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem' }}>
            ...
            <div>
              <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.95rem' }}>Pagamento contra reembolso</div>
              <div style={{ color: '#64748b', fontSize: '0.85rem' }}>Pagará ao estafeta em dinheiro</div>
            </div>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem' }}>
            ...
            <div>
              ...
              <div style={{ color: '#64748b', fontSize: '0.85rem' }}>Devolvemos o dinheiro se não ficar satisfeito</div>
            </div>
          </div>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.85rem', color: '#64748b', marginBottom: '0.25rem' }}>Precisa de ajuda ou quer devolver o produto?</div>
