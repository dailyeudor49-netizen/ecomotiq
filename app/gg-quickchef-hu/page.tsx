        ...
        <div className="bg-white border-4 border-red-600 p-6 rounded-xl max-w-2xl mx-auto mb-8 relative shadow-xl transform transition-transform hover:scale-[1.01]">
          ...
          <div className="flex flex-col items-center justify-center mb-6 mt-6">
             ...
             <div className="flex items-center gap-3">
               ...
               <span className="text-5xl md:text-6xl font-black text-red-600 tracking-tighter">34 599<span className="text-3xl"> Ft</span></span>
             </div>
             <p className="text-green-700 font-bold mt-2">Megtakarítasz 34 599 Ft-ot!</p>
          </div>
...
const OrderForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    sessionStorage.setItem('ec_value', '34599'); // Price in HUF
      ...
      <div className="max-w-xl mx-auto bg-white rounded-xl shadow-2xl overflow-hidden">
        ...
        <div className="p-5 md:p-8">
          <div className="flex justify-between items-center mb-6 pb-6 border-b border-gray-200 bg-gray-50 p-4 rounded-lg">
            <div>
              <p className="text-gray-500 line-through text-sm">Listaár: 69 198 Ft</p>
              <p className="text-red-600 font-bold text-2xl">Összesen: 34 599 Ft</p>
              <p className="text-green-600 font-semibold text-sm">Megtakarítasz 34 599 Ft-ot!</p>
            </div>
