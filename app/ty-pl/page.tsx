    ...
    if (typeof window !== 'undefined' && !alreadyTracked) {
      ...
      script.onload = async () => {
        ...
        window.gtag('event', 'conversion', {
          'send_to': 'AW-17218323030/BKoRCIrVh-8bENaEq5JA',
          'value': ecValue,
          'currency': 'PLN',
    ...
    <div className="ty-container" style={{
      ...
      <div className="ty-box" style={{
        ...
        <p style={{
          ...
          Twoje zamówienie zostało pomyślnie przetworzone.
        </p>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem' }}>
            ...
            <div>
              ...
              <div style={{ color: '#64748b', fontSize: '0.85rem' }}>Zapłacisz kurierowi gotówką</div>
            </div>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem' }}>
            ...
            <div>
              <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.95rem' }}>Darmowa wysyłka</div>
              <div style={{ color: '#64748b', fontSize: '0.85rem' }}>Dostawa w ciągu 2-3 dni roboczych</div>
            </div>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem' }}>
            ...
            <div>
              ...
              <div style={{ color: '#64748b', fontSize: '0.85rem' }}>Zwrócimy pieniądze, jeśli nie będziesz zadowolony</div>
            </div>
          </div>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.85rem', color: '#64748b', marginBottom: '0.25rem' }}>Potrzebujesz pomocy lub chcesz zwrócić produkt?</div>
          <a href="mailto:info@ecomotiq.com" style={{ color: '#FF8C00', fontWeight: 600, textDecoration: 'none', fontSize: '0.95rem' }}>info@ecomotiq.com</a>
          <div style={{ fontSize: '0.8rem', color: '#94a3b8', marginTop: '0.5rem' }}>Możesz zwrócić produkt w ciągu 30 dni, jeśli nie jesteś zadowolony</div>
        </div>
